...
| ADR-0004 | Persistent disk identity plus H240 physical truth | ACCEPTED / VALIDATED | Correlate exact identity with H240 Port/Box/Bay events; newer removal state overrides retained inventory |
...
| ADR-0009 | GitHub documentation source of truth | ACCEPTED | Approved sanitized engineering documentation is version-controlled here |
